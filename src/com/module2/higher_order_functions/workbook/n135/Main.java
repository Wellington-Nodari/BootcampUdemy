package com.module2.higher_order_functions.workbook.n135;
...
public class Main {
    public static void main(String[] args) {
        ...
        books.stream()
                ...
                .map(book -> new Book (book.getTitle(), book.getGenre(), book.getYear(), book.getPrice() * 0.5)) // attention to this - creating a new object
                .sorted((book1, book2) -> book1.getYear().compareTo(book2.getYear()))
                .forEach(book -> System.out.println(book.getGenre() + " " + book.getYear() + " " + book.getPrice() + " " + book.getTitle())); // terminal operation
    }
}
