package com.module2.map_collections.hashmap_treemap;
...
public class Inventory {
    public static void main(String[] args) {
        ...
        // inventory.put("Banana", 3.99); // como oq determina essa entrada no map eh o valor do hash que eh obtido pela string (banana),
                                        // neste caso entao nao seria uma nova entrada no map, mas sim um update no value.
         ...
         String response = result ? "Yes!" : "No, sorry!";  // this is called TERNARY expression where it improves the readability for if/else statements (if result is true do 1st expression, else do the 2nd.
